...
public class ImageController {
    ...
    public String upload(@RequestParam("title") String title, @RequestParam("description") String description,
                         @RequestParam("file") MultipartFile file, @RequestParam("tags") String tags, HttpSession
    ...
    public String edit(@PathVariable int id, @RequestParam("title") String title, @RequestParam("description") String
            description, @RequestParam("file") MultipartFile file, @RequestParam("tags") String tags) throws
            IOException {
        Image image = imageService.getById(id);
        List<Tag> imageTags = findOrCreateTags(tags);
    ...
    private String convertTagsToString(List<Tag> tags) {
        ...
        if (!tags.isEmpty()) {
            ...
            tagBuilder.append(lastTag.getName());
        }
